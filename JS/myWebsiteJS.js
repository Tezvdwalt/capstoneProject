$(document).ready(function () {
  //Check if savedItems exists in local storage
  ...
  $(".save_btn").click(function () {
    let item = $(this).closest(".item").html();
...
//Show saved items if user is on the Saved_for_Later page
